...
export type AccountedSource =
    (typeof AccountedSource)[keyof typeof AccountedSource];
...
export type EntryExitSource =
    (typeof EntryExitSource)[keyof typeof EntryExitSource];
...
export type EvacuationStatus =
    (typeof EvacuationStatus)[keyof typeof EvacuationStatus];
...
export type HardwareStatus =
    (typeof HardwareStatus)[keyof typeof HardwareStatus];
...
export type PermitApprovalAction =
    (typeof PermitApprovalAction)[keyof typeof PermitApprovalAction];
...
export type PortableDeviceStatus =
    (typeof PortableDeviceStatus)[keyof typeof PortableDeviceStatus];
...
export type WorkerDocumentVerificationStatus =
    (typeof WorkerDocumentVerificationStatus)[keyof typeof WorkerDocumentVerificationStatus];

export const WorkerDocumentVerificationStatusLabels: Record<
    WorkerDocumentVerificationStatus,
    string
> = {
    pending: 'Pending',
    verified: 'Verified',
...
export const Permission = {
    ...
    ViewPortableDevices: 'view-portable-devices',
    CreatePortableDevices: 'create-portable-devices',
    UpdatePortableDevices: 'update-portable-devices',
    CreateEvacuation: 'create-evacuation',
    UpdateEvacuation: 'update-evacuation',
    ViewGas: 'view-gas',
    ViewGasThresholds: 'view-gas-thresholds',
    UpdateGasThresholds: 'update-gas-thresholds',
    ...
    ViewLsr: 'view-lsr',
    CreateLsr: 'create-lsr',
    UpdateLsr: 'update-lsr',
    ViewPermits: 'view-permits',
    CreatePermits: 'create-permits',
    UpdatePermits: 'update-permits',
    CreatePermitGasTests: 'create-permit-gas-tests',
    ViewPermitCatalogue: 'view-permit-catalogue',
    CreatePermitCatalogue: 'create-permit-catalogue',
    UpdatePermitCatalogue: 'update-permit-catalogue',
    DeletePermitCatalogue: 'delete-permit-catalogue',
    ViewWorkerDocuments: 'view-worker-documents',
    CreateWorkerDocuments: 'create-worker-documents',
    UpdateWorkerDocuments: 'update-worker-documents',
    DeleteWorkerDocuments: 'delete-worker-documents',
    ViewReports: 'view-reports',
    CreateReports: 'create-reports',
    UpdateReports: 'update-reports',
    ViewVehicleViolations: 'view-vehicle-violations',
    CreateVehicleViolations: 'create-vehicle-violations',
    DeleteVehicleViolations: 'delete-vehicle-violations',
