...
it('treats weather refresh as fixed hourly', function () {
    expect(app(WeatherSettings::class)->refreshMinutes())->toBe(60)
        ->and(app(WeatherSettings::class)->staleMinutes())->toBe(120);
});
