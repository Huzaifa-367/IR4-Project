    ...
    return (
        <>
            ...
            <CrudFormDialog
                ...
                action={
                    form?.mode === 'edit'
                        ? `/settings/devices/${form.device.id}`
                        : '/settings/devices'
                }
            ...
            <ConfirmActionDialog
                ...
                action={
                    tokenConfirm
                        ? `/settings/devices/${tokenConfirm.id}/token`
                        : undefined
                }
                method="post"
                confirmLabel={
            ...
            <ConfirmActionDialog
                ...
                action={
                    retireTarget
                        ? `/settings/devices/${retireTarget.id}/status`
                        : undefined
                }
                method="patch"
                data={{ status: 'retired' }}
            ...
            <CrudFormDialog
                ...
                action={
                    statusTarget
                        ? `/settings/devices/${statusTarget.id}/status`
                        : '/settings/devices'
                }
                method="patch"
...
DevicesIndex.layout = {
    breadcrumbs: [{ title: 'Devices', href: '/settings/devices' }],
};
